// This was bought on the Asset store but has been heavily modified
using UnityEngine;
...
#pragma warning restore 0414
    ...
    public Func<int, Transform, GameObject> itemRendererFactory { get; set; }
    public Func<int, int> onGetItemType
    {
        set { _onGetItemType = value; }
	...
	{
		if (!Application.isPlaying || content == null || listInfo.scrollToIndex != -1)
		{
			return;
		}
